...
7. **Slim progress rail and scroll cues.** Fixed left rail with a traveling orange segment, circular up/down controls, hero copy track with an orange segment, marquee band, and the device SCROLL pill.
